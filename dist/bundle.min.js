(() => {
    var e = {
            ...
            361: (e, t, n) => {
                ...
                function d(e, t) {
                    ...
                    for (n = 0; n < f.length; ++n)
                        for (h[f[n]] = [], d = 0; d < e.length; ++d) {
                            const t = e[d][f[n]];
                            void 0 !== t && h[f[n]].push(t);
                        }
                    function m(e) {
                        const t = e.id ? "#" + e.id : "",
                    ...
                    function _(e, t) {
                        ...
                        if ("!" === f)
                            ...
                            for (
                                d < m &&
                                    y.setAttribute("id", f.slice(d + 1, m)),
                                    s > 0 &&
                                        y.setAttribute(
                                            "class",
                            ...
                            if (i(p))
                                for (o = 0; o < p.length; ++o) {
                                    const e = p[o];
                                    null != e && g.appendChild(y, _(e, t));
                                }
                            else
                                a(e.text) &&
                                    g.appendChild(y, g.createTextNode(e.text));
                            const C = e.data.hook;
                            u(C) &&
                                (null === (r = C.create) ||
                                    void 0 === r ||
                    ...
                    function y(e, t, n, r, o, i) {
                        for (; r <= o; ++r) {
                            const o = n[r];
                            null != o && g.insertBefore(e, _(o, i), t);
                        }
                    }
                    function C(e) {
                        var t, n;
                        ...
                        if (void 0 !== r) {
                            null ===
                                ...
                                void 0 === n ||
                                n.call(t, e);
                            for (let t = 0; t < h.destroy.length; ++t)
                                h.destroy[t](e);
                            ...
                            if (null != s)
                                if (u(s.sel)) {
                                    C(s),
                                        (r = h.remove.length + 1),
                                        (a = v(s.elm, r));
                                    for (let e = 0; e < h.remove.length; ++e)
                                        h.remove[e](s, a);
                                    const e =
                                        null ===
                                            (i =
                    ...
                    function w(e, t, n) {
                        ...
                        const f =
                            null === (r = t.data) || void 0 === r
                                ? void 0
                                : r.hook;
                        null === (o = null == f ? void 0 : f.prepatch) ||
                            void 0 === o ||
                            o.call(f, e, t);
                        const d = (t.elm = e.elm),
                            m = e.children,
                            ...
                            s(t.text)
                                ? u(m) && u(v)
                                    ...
                                    ? (u(e.text) && g.setTextContent(d, ""),
                                      y(d, null, v, 0, v.length - 1, n))
                                    : u(m)
                                    ? b(d, m, 0, m.length - 1)
                                    : u(e.text) && g.setTextContent(d, "")
                                : e.text !== t.text &&
                                  (u(m) && b(d, m, 0, m.length - 1),
                                  g.setTextContent(d, t.text)),
                                null ===
                                    (l = null == f ? void 0 : f.postpatch) ||
                                    void 0 === l ||
                                    l.call(f, e, t);
                        }
                    }
                ...
                function h(e, t, n) {
                    if (
                        ...
                        for (let e = 0; e < t.length; ++e) {
                            const n = t[e].data;
                            void 0 !== n && h(n, t[e].children, t[e].sel);
                        }
                }
                function g(e, t, n) {
                    let r,
                ...
                const T = { create: M, update: M };
                function P(e, t, n) {
                    if ("function" == typeof e) e.call(t, n, t);
                    else if ("object" == typeof e)
                        for (let r = 0; r < e.length; r++) P(e[r], t, n);
                }
                function R(e, t) {
                    const n = e.type,
                        r = t.data.on;
                ...
                const D = { create: j, update: j, destroy: j };
                function F(e, t) {
                    let n, r, o;
                    const i = t.elm;
                    let a = e.data.props,
                ...
                (u.fromSourceMap = function (e) {
                    ...
                    (l.prototype._parseMappings = function (e, t) {
                        for (
                            ...
                            if (";" === e.charAt(_)) p++, _++, (f = 0);
                            else if ("," === e.charAt(_)) _++;
                            else {
                                for (
                                    (n = new c()).generatedLine = p, u = _;
                                    u < v &&
                                    !this._charIsMappingSeparator(e, u);
                                    u++
                                );
                                if ((i = y[(o = e.slice(_, u))])) _ += o.length;
                                else {
                                    for (i = []; _ < u; )
                                        a.decode(e, _, C),
                                            (l = C.value),
            ...
            786: (e, t, n) => {
                ...
                (s.fromStringWithSourceMap = function (e, t, n) {
                    ...
                    return (
                        ...
                        a.length > 0 && (p && f(p, u()), r.add(a.join(""))),
                    ...
                    i = (function () {
                        ...
                        return (
                            ...
                            (e.prototype.watch = function (e, t) {
                                var n = o.getKeyFromStack("compile");
                            ...
                            (e.prototype.child = function (e) {
                                var t = o.getKeyFromStack("compile");
                            ...
                            (e.prototype.elementsFromDOM = function (e) {
                                return document.querySelectorAll(
                                    e + '[data-reachid="' + this._id + '"]',
                                );
                            }),
                            e
                        );
                    ...
                    a = (function () {
                        ...
                        return (
                            (e.prototype.addRootImage = function (e) {
                                (this._rootComponent = e), (e._page = this);
                                var t = e._compile(),
                                    n = o._traverseRenderPipeline(
                                        this._rootComponent,
                                    ),
                                    r = i.textToNode(t);
                                o._insertEvents(n, r),
                                    (this._currentTree = i.forkedToVNode(r)),
                                    document.body.appendChild(r),
                                    n.map(o._fireDeferCallbacks),
                                    n.map(o._resetRenderPipeline);
                            }),
            ...
            775: (e, t) => {
                ...
                (t.__esModule = !0),
                    ...
                    (t._fireFlushCallbacks = function (e) {
                        e._flushCallbacks.forEach(function (e) {
                            e();
                        }),
                            (e._flushCallbacks = []);
                    }),
                    (t._fireDeferCallbacks = function (e) {
                        e._deferCallbacks.forEach(function (e) {
                            e();
                        }),
                            (e._deferCallbacks = []);
                    }),
            ...
            5: (e, t, n) => {
                ...
                (t.generateId = function () {
                    ...
                    (t.textToNode = function (e) {
                        var t = "<div>" + e + "</div>";
                        return new DOMParser().parseFromString(t, "text/html")
                            .body.firstChild;
                    }),
                    (t.getKeyFromStack = function (e) {
                        for (
                    ...
                    (t.isArrayDeepEqual = function (e, t) {
                        return 0 === o.diff(e, t).length;
                    }),
                    (t.forkedToVNode = function (e, n) {
                        var o,
    ...
    (n.d = (e, t) => {
        ...
        (() => {
            "use strict";
            var e = n(255);
            new (n(220).Page)("counter").addRootImage(new e.Layout());
        })();
})();
