(() => {
    var e = {
            ...
            361: (e, t, n) => {
                ...
                const F = { create: T, update: T, destroy: T };
                function $(e, t) {
                    let n, r, o;
                    const i = t.elm;
                    let a = e.data.props,
                        ...
                        return (
                            ...
                            (e.prototype.child = function (e) {
                                var t = i.getSync(),
                                    n = t
                                        .filter(function (e) {
                                            return "functionName" in e;
                                        })
                                        .find(function (e) {
                                            return e.functionName.includes(
                                                "mountIfNeeded",
                                            );
                                        }),
                                    r = t.indexOf(n),
                                    o = t
                                        ...
                                        .join("");
                                return o in this.children
                                    ? (this.children[o].mountIfNeeded(),
                                      this.children[o].id)
                                    : ((e.page = this.page),
                                      (e.parent = this),
                                      (this.children[o] = e),
            ...
            220: (e, t, n) => {
                ...
                var r = n(361),
                    o = r.init([r.datasetModule]),
                    i = (function () {
                        function e(e) {
                            (this.callbacks = {}), (this.name = e);
                        }
                        return (
                            ...
                            (e.prototype.render = function () {
                                ...
                                var t = r.toVNode(e);
                                this.addDataset(t),
                                    o(this.currentTree, t),
                                    (this.currentTree = t);
                            }),
                            (e.prototype.textToNode = function (e) {
                                var t = "<div>" + e + "</div>";
                            ...
                            (e.prototype.addDataset = function (e) {
                                var t = this;
                                Object.keys(e.data.attrs).length > 0 &&
                                    Object.keys(e.data.attrs).forEach(function (
                                        t,
                                    ) {
                                        t.includes("data-") &&
                                            ("dataset" in e.data ||
                            ...
                            (e.prototype.injectCallbacks = function (e) {
                                    ...
                                    t.forEach(function (t) {
                                        ...
                                        if (n) {
                                            ...
                                            for (
                                                ...
                                                var o =
                                                    n.attributes[r].nodeName;
                                                n.attributes[r].nodeValue ==
                                                    t.callbackId &&
                                                    (n.removeAttribute(o),
                                                    (n[o] = t.callback));
                                            }
                                        } else console.log("WARN: Unmounted component exists: " + t.name + " - " + t.id);
                                    });
                                }),
                                    (this.callbacks = {});
                            }),
                            (e.prototype.importCSS = function (e) {
