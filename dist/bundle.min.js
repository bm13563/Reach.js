    ...
    var e = {
            ...
            361: (e, t, n) => {
                ...
                function f(e, t) {
                    ...
                    for (n = 0; n < p.length; ++n)
                        for (h[p[n]] = [], f = 0; f < e.length; ++f) {
                            const t = e[f][p[n]];
                            void 0 !== t && h[p[n]].push(t);
                        }
                    function m(e) {
                        const t = e.id ? "#" + e.id : "",
                    ...
                    function y(e, t) {
                        ...
                        if ("!" === p)
                            ...
                            for (
                                f < m &&
                                    _.setAttribute("id", p.slice(f + 1, m)),
                                    s > 0 &&
                                        _.setAttribute(
                                            "class",
                    ...
                    function b(e, t, n) {
                        ...
                        const p =
                            null === (r = t.data) || void 0 === r
                                ? void 0
                                : r.hook;
                        null === (o = null == p ? void 0 : p.prepatch) ||
                            void 0 === o ||
                            o.call(p, e, t);
                        const f = (t.elm = e.elm),
                            m = e.children,
                        ...
                        if (e !== t) {
                            ...
                            s(t.text)
                                ? u(m) && u(v)
                                    ...
                                    : u(v)
                                    ? (u(e.text) && g.setTextContent(f, ""),
                                      _(f, null, v, 0, v.length - 1, n))
                                    : u(m)
                                    ? w(f, m, 0, m.length - 1)
                                    : u(e.text) && g.setTextContent(f, "")
                                : e.text !== t.text &&
                                  (u(m) && w(f, m, 0, m.length - 1),
                                  g.setTextContent(f, t.text)),
                                null ===
                                    (l = null == p ? void 0 : p.postpatch) ||
                                    void 0 === l ||
                                    l.call(p, e, t);
                        }
                    }
            ...
            667: (e, t, n) => {
                ...
                (u.fromSourceMap = function (e) {
                    ...
                    (l.prototype._parseMappings = function (e, t) {
                        ...
                        s(b, r.compareByGeneratedPositionsDeflated),
            ...
            786: (e, t, n) => {
                ...
                (s.fromStringWithSourceMap = function (e, t, n) {
                    ...
                    return (
                        ...
                        a.length > 0 && (d && p(d, u()), r.add(a.join(""))),
                ...
                var o = n(5),
                    ...
                    a = (function () {
                        ...
                        return (
                            ...
                            (e.prototype.mountIfNeeded = function () {
                                return this.shouldMount
                                    ? (this.mount(), this.html)
                                    : this.html;
                            }),
                            ...
                            (e.prototype.flush = function (e) {
                                this.flushCallbacks.push(e);
                            }),
                            (e.prototype.defer = function (e) {
                                this.deferCallbacks.push(e);
                            }),
                            ...
                            (e.prototype.parentShouldMount = function () {
                                this.parent &&
                            ...
                            (e.prototype.elementFromDOM = function (e) {
                                return document.querySelectorAll(
                                    e + '[data-reachid="' + this.id + '"]',
                                );
                            }),
                            e
                        );
            ...
            220: (e, t, n) => {
                ...
                var r = n(361),
                    ...
                    i = (function () {
                        function e(e) {
                            (this.patch = r.init([])), (this.name = e);
                        }
                        return (
                            (e.prototype.addRootImage = function (e) {
                                (this.rootComponent = e), (e.page = this);
                                var t = e.mountIfNeeded(),
                                    n = this.traverseRenderPipeline(),
                                    r = o.textToNode(t);
                                this.insertEvents(n, r),
                                    (this.currentTree = o.forkedToVNode(r)),
                                    document.body.appendChild(r),
                                    n.map(this.fireDeferCallbacks),
                                    n.map(this.resetRenderPipeline);
                            }),
                            (e.prototype.render = function () {
                                var e = this.traverseRenderPipeline();
                                e.map(this.fireFlushCallbacks);
                                var t = this.rootComponent.mountIfNeeded(),
                                    n = o.textToNode(t);
                                this.insertEvents(e, n);
                                var r = o.forkedToVNode(n);
                                this.patch(this.currentTree, r),
                                    (this.currentTree = r),
                                    e.map(this.fireDeferCallbacks),
                                    e.map(this.resetRenderPipeline),
                                    (this.rootComponent.shouldMount = !0);
                            }),
                            (e.prototype.traverseRenderPipeline = function (e) {
                                void 0 === e && (e = this.rootComponent);
                                var t = [];
                                e.shouldMount && t.push(e);
                                for (
                                    var n = 0, r = Object.entries(e.children);
                                    n < r.length;
                                    n++
                                ) {
                                    var o = r[n],
                                    ...
                                    i.shouldMount &&
                                        t.push.apply(
                                            t,
                                            this.traverseRenderPipeline(i),
                                        );
                                }
                                return t;
                            }),
                            (e.prototype.fireFlushCallbacks = function (e) {
                                e.flushCallbacks.forEach(function (e) {
                                    e();
                                }),
                                    (e.flushCallbacks = []);
                            }),
                            (e.prototype.fireDeferCallbacks = function (e) {
                                e.deferCallbacks.forEach(function (e) {
                                    e();
                                }),
                                    (e.deferCallbacks = []);
                            }),
                            (e.prototype.getEventCallbacks = function (e) {
                                return e.eventCallbacks;
                            }),
                            (e.prototype.resetRenderPipeline = function (e) {
                                e.shouldMount = !1;
                            }),
                            (e.prototype.insertEvents = function (e, t) {
                                e
                                    .map(function (e) {
                                        return e.eventCallbacks;
                                    })
            ...
            5: (e, t, n) => {
                "use strict";
                (t.__esModule = !0),
                    (t.forkedToVNode = t.textToNode = t.generateId = void 0);
                var r = n(361);
